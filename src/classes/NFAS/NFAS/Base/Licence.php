...
abstract class Licence implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\NFAS\\NFAS\\Map\\LicenceTableMap';
    ...
    /**
     * Initializes internal state of NFAS\NFAS\Base\Licence object.
     */
     ...
     *
     * @return $this|Licence The current object, for fluid interface
     */
     ...
     * @return $this|\NFAS\NFAS\Licence The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[LicenceTableMap::COL_ID] = true;
        }
    ...
    public function setClubId($v)
    {
        ...
        if ($this->club_id !== $v) {
            $this->club_id = $v;
            $this->modifiedColumns[LicenceTableMap::COL_CLUB_ID] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[LicenceTableMap::COL_TYPE] = true;
        }
    ...
    public function setStart($v)
    {
        ...
        if ($this->start !== null || $dt !== null) {
            if ($this->start === null || $dt === null || $dt->format("Y-m-d") !== $this->start->format("Y-m-d")) {
                ...
                $this->modifiedColumns[LicenceTableMap::COL_START] = true;
            }
    ...
    public function setEnd($v)
    {
        ...
        if ($this->end !== null || $dt !== null) {
            if ($this->end === null || $dt === null || $dt->format("Y-m-d") !== $this->end->format("Y-m-d")) {
                ...
                $this->modifiedColumns[LicenceTableMap::COL_END] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LicenceTableMap::translateFieldName('ClubId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->club_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LicenceTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : LicenceTableMap::translateFieldName('Start', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->start = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : LicenceTableMap::translateFieldName('End', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = LicenceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\NFAS\\NFAS\\Licence'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LicenceTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(LicenceTableMap::COL_CLUB_ID)) {
            $modifiedColumns[':p' . $index++]  = 'club_id';
        }
        if ($this->isColumnModified(LicenceTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(LicenceTableMap::COL_START)) {
            $modifiedColumns[':p' . $index++]  = 'start';
        }
        if ($this->isColumnModified(LicenceTableMap::COL_END)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Licence'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Licence'][$this->hashCode()] = true;
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\NFAS\NFAS\Licence The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LicenceTableMap::COL_ID)) {
            $criteria->add(LicenceTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(LicenceTableMap::COL_CLUB_ID)) {
            $criteria->add(LicenceTableMap::COL_CLUB_ID, $this->club_id);
        }
        if ($this->isColumnModified(LicenceTableMap::COL_TYPE)) {
            $criteria->add(LicenceTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(LicenceTableMap::COL_START)) {
            $criteria->add(LicenceTableMap::COL_START, $this->start);
        }
        if ($this->isColumnModified(LicenceTableMap::COL_END)) {
            $criteria->add(LicenceTableMap::COL_END, $this->end);
        }
    ...
    {
        $criteria = ChildLicenceQuery::create();
        $criteria->add(LicenceTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \NFAS\NFAS\Licence (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \NFAS\NFAS\Licence Clone of current object.
     * @throws PropelException
     */
