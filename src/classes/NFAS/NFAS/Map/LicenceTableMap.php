...
use NFAS\NFAS\Licence;
use NFAS\NFAS\LicenceQuery;
...
class LicenceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'NFAS.NFAS.Map.LicenceTableMap';
     ...
     */
    const OM_CLASS = '\\NFAS\\NFAS\\Licence';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'NFAS.NFAS.Licence';
     ...
     */
    const COL_ID = 'Licence.id';

    /**
     * the column name for the club_id field
     */
    const COL_CLUB_ID = 'Licence.club_id';

    /**
     * the column name for the type field
     */
    const COL_TYPE = 'Licence.type';

    /**
     * the column name for the start field
     */
    const COL_START = 'Licence.start';

    /**
     * the column name for the end field
     */
    const COL_END = 'Licence.end';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ClubId', 'Type', 'Start', 'End', ),
        self::TYPE_CAMELNAME     => array('id', 'clubId', 'type', 'start', 'end', ),
        self::TYPE_COLNAME       => array(LicenceTableMap::COL_ID, LicenceTableMap::COL_CLUB_ID, LicenceTableMap::COL_TYPE, LicenceTableMap::COL_START, LicenceTableMap::COL_END, ),
        self::TYPE_FIELDNAME     => array('id', 'club_id', 'type', 'start', 'end', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ClubId' => 1, 'Type' => 2, 'Start' => 3, 'End' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'clubId' => 1, 'type' => 2, 'start' => 3, 'end' => 4, ),
        self::TYPE_COLNAME       => array(LicenceTableMap::COL_ID => 0, LicenceTableMap::COL_CLUB_ID => 1, LicenceTableMap::COL_TYPE => 2, LicenceTableMap::COL_START => 3, LicenceTableMap::COL_END => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'club_id' => 1, 'type' => 2, 'start' => 3, 'end' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\NFAS\\NFAS\\Licence');
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(LicenceTableMap::COL_ID);
            $criteria->addSelectColumn(LicenceTableMap::COL_CLUB_ID);
            $criteria->addSelectColumn(LicenceTableMap::COL_TYPE);
            $criteria->addSelectColumn(LicenceTableMap::COL_START);
            $criteria->addSelectColumn(LicenceTableMap::COL_END);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \NFAS\NFAS\Licence) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(LicenceTableMap::DATABASE_NAME);
            $criteria->add(LicenceTableMap::COL_ID, (array) $values, Criteria::IN);
        }
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                LicenceTableMap::removeInstanceFromPool($singleval);
            }
        }
