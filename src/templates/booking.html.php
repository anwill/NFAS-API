...
<div align="center">
    <table class="smarttable" width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
        ...
        <tr>
            ...
            <?php } ?>
        <tr>
            <th valign="top" style="padding:5px; font-family: Arial,sans-serif; font-size: 16px; line-height:20px;" colspan="6">Please contact the above booker's email to confirm that these archers are booked into your shoot</th>
        </tr>
    </table>
